...
const QuestionTile = ({parameter, updateStats}) => {
    ...
    const areas = ['one', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'ten'];
    const areasInput = ['inputOne', 'inputTwo', 'inputThree', 'inputFour', 'inputFive', 'inputSix', 'inputSeven', 'inputEight', 'inputNine', 'inputTen'];
