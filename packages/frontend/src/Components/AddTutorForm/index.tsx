                    ...
                    <div className="form-row">
                        <span className="form-field">
                            ...
                            <FormInput
                                ...
                                name={"firstName"}
                                type={"text"}
                                value={this.state.newTutor !== undefined ? this.state.newTutor.firstName : ''}
                                placeholder={'Jane'}
                    ...
                    <div className="form-row">
                        <span className="form-field">
                            ...
                            <FormInput
                                ...
                                name={"lastName"}
                                type={"text"}
                                value={this.state.newTutor !== undefined ? this.state.newTutor.lastName : ''}
                                placeholder={'Doe'}
                                handleChange={this.handleInput}
                                required={true}
                            />
                    ...
                    <div className="form-row">
                        <span className="form-field">
                            ...
                            <FormInput
                                ...
                                name={"major"}
                                type={"text"}
                                value={this.state.newTutor !== undefined ? this.state.newTutor.major : ''}
                    ...
                    <div className="form-row">
                        <span className="form-field">
                            ...
                            <FormDate
                                id={"since"}
                                name={"since"}
                                value={this.state.newTutor !== undefined ? this.state.newTutor.since : ''}
                    ...
                    <div className="form-row">
                        <span className="form-field">
                            ...
                            <FormList
                                ...
                                type={"text"}
                                placeholder={'CSC221'}
                                value={this.state.newTutor !== undefined ? this.state.newTutor.courses : []}
